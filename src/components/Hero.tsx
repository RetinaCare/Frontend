      ...
      <div className="max-w-[1440px] relative mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center z-10">
        ...
        >
          ...
          <p
            ...
            "
          >
            We're dedicated to helping you take control of your well-being, with a 
            focus on diabetes care and prevention. Our goal is to guide, support, 
            and empower you with the knowledge and tools you need to live a healthier, 
            more confident life.
          </p>
